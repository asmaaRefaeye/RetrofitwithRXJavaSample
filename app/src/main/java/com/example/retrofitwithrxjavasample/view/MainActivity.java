...
import com.example.retrofitwithrxjavasample.network.ApiClient;
import com.example.retrofitwithrxjavasample.network.ApiService;
...
import com.example.retrofitwithrxjavasample.utils.MyDividerItemDecoration;
import com.example.retrofitwithrxjavasample.utils.PrefUtil;
import com.example.retrofitwithrxjavasample.utils.RecyclerTouchListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * */
        if (TextUtils.isEmpty(PrefUtil.getApiKey(this))) {
            registerUser();
        } else {
                ...
                apiService
                        ...
                        .subscribeWith(new DisposableSingleObserver<User>() {
                            ...
                            public void onSuccess(User user) {
                                ...
                                PrefUtil.storeApiKey(getApplicationContext(), user.getApi_key());
    ...
    private void updateNote(int noteId, final String note, final int position) {
        disposable.add(
                apiService.updateNote(noteId, note).complete()
